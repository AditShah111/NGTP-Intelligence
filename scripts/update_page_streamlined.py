page_code_streamlined = """'use client';
        ...
        {isLoading && (
          <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 flex items-center justify-between text-xs text-amber-900 font-medium animate-pulse shadow-sm">
            <div className="flex items-center gap-2.5">
              ...
              <span>
                Running all legal intelligence agents in background (Document Parsing, Supreme Court Precedent Ingestion, Article 141 Hierarchy, and Statutory Math)...
              </span>
            </div>
...
with open("src/app/page.tsx", "w", encoding="utf-8") as f:
    f.write(page_code_streamlined)

print("Updated page.tsx with single-screen executive UI and background execution!")