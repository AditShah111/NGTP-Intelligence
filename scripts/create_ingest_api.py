...
os.makedirs("src/app/api/ingest-precedents", exist_ok=True)
with open("src/app/api/ingest-precedents/route.ts", "w", encoding="utf-8") as f:
    f.write(api_route)

print("Created src/app/api/ingest-precedents/route.ts!")