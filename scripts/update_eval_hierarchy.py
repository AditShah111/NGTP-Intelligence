...
with open("src/service/evaluator-agent.ts", "w", encoding="utf-8") as f:
    f.write(code_eval_hierarchy)

print("Updated src/service/evaluator-agent.ts with Article 141 Judicial Hierarchy & Conflict Resolution!")