code_gatekeeper_refined = """import { CaseDocument } from '../types/index';
...
with open("src/service/ngtp-gatekeeper.ts", "w", encoding="utf-8") as f:
    f.write(code_gatekeeper_refined)

print("Updated src/service/ngtp-gatekeeper.ts to strictly reject out-of-scope domains without false positives!")