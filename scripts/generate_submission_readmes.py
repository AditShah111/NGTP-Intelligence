sub_dir = "AICA-L2-CA-Adit-Shah-GST-NGTP-Litigation-Engine"
...
with open(f"{sub_dir}/00_READ_ME_FIRST.txt", "w", encoding="utf-8") as f:
    f.write(read_me_first)

# Exhaustive README.md
readme_content = """# GST NGTP Litigation Intelligence Engine & Precedent Harmonizer
...
with open(f"{sub_dir}/README.md", "w", encoding="utf-8") as f:
    f.write(readme_content)

# Also update the repository root README.md
with open("README.md", "w", encoding="utf-8") as f:
    f.write(readme_content)

print("Generated 00_READ_ME_FIRST.txt, submission README.md, and root README.md successfully!")