  ...
  return [
    ...
    },
    {
      ...
      allegedFact: hasTransit 
        ...
        : `NO E-WAY BILLS OR TRANSIT PROOF UPLOADED. Movement of goods is uncorroborated.`,
      sourceDocument: hasTransit ? documents.find(d => d.type === 'E-Way Bill' || d.type === 'Transporter Bilty')?.name || 'Uploaded E-Way Bills' : 'NONE (Missing Evidentiary Proof)',
      pageParagraph: hasTransit ? 'Verified from uploaded file' : 'N/A',
      evidenceStrength: hasTransit ? 'Established' : 'Unsupported',
      contradiction: hasTransit ? 'None.' : 'High risk of fake billing / non-transit allegation under Section 74.',
    ...
    },
    {
      ...
      allegedFact: hasBank 
        ...
        : `NO BANK STATEMENT OR PAYMENT PROOF UPLOADED. Consideration and tax payment to supplier is unverified.`,
      ...
      contradiction: hasBank ? 'None.' : 'Taxpayer cannot claim bona fide buyer protection or invoke Suncraft without bank payment proof.',
