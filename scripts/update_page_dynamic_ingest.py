...
export default function HomePage() {
  ...
  // Real-Time Precedent Ingestion and Dynamic Parameter Auto-Calibration
  const handleIngestPrecedents = async (domain: string) => {
        ...
        {isIngesting && (
          <div className="mb-4 p-3.5 rounded-xl bg-purple-50 border border-purple-200 flex items-center justify-between text-xs text-purple-900 font-medium animate-pulse shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <span>Ingesting latest Indian High Court / Supreme Court precedents and extracting court evidentiary ratios...</span>
            </div>
