...
benchmarks = [case1]
code_out = f"import {{ CaseStudy }} from '../types';\n\nexport const BENCHMARK_CASES: CaseStudy[] = {json.dumps(benchmarks, indent=2)};\n"

with open("src/repo/benchmark-data.ts", "w", encoding="utf-8") as f:
    f.write(code_out)

print("Updated benchmark-data.ts")